      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage your academic qualifications and certifications</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-8 animate-fadeIn">
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-gray-700">
                    Year / Duration <span className="text-red-500">*</span>
                  </label>
                  <div className="flex items-center">
                    <div className="bg-gray-100 p-3 rounded-l-xl border-2 border-r-0 border-gray-200">
                ...
                <div className="md:col-span-2 space-y-2">
                  ...
                  <div className="flex items-start">
                    ...
                    <textarea
                      name="description"
                      placeholder="Describe your studies, achievements, key courses, etc."
                      value={formData.description}
                      onChange={handleInputChange}
                      rows="4"
        ...
        <div className="space-y-4">
          {educationList.length === 0 ? (
            <div className="bg-white rounded-2xl shadow-xl p-16 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">No education records yet</h3>
              <p className="text-gray-600 mb-6">Start building your academic portfolio by adding your first education record</p>
              {!isAdding && (
                <button
                  onClick={() => setIsAdding(true)}
                      ...
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
                        ...
                        <div className="flex items-center space-x-2">
                          <div className="px-4 py-2 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg border border-indigo-100">
                            <span className="text-sm font-semibold text-indigo-700 flex items-center">
